...
public class RevertStatus implements Command {
    ...
    public RevertStatus(TrelloBoardRepository trelloBoardRepository) {
    ...
    public String execute(List<String> parameters) {
        ...
        return revertStatus(id);
    }

    private String revertStatus(int id) {
        ...
        if (!trelloBoardRepository.getWorkItems().containsKey(id)) {
            ...
            String result = String.format(
                    CommandConstants.REVERT_STATUS_WORKIITEM_SUCCESS_MESSAGE,
                    workItem.getId(),
                    workItem.getTitle(),
                    workItem.getStatus(),
                    workItem.getStatus().getPrevious());

            workItem.revertStatus();
