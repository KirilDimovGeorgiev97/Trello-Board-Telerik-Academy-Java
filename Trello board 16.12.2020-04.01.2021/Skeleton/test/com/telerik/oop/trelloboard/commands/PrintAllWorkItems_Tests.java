...
import com.telerikacademy.oop.trelloboard.commands.listWorkItems.PrintAllWorkItems;
...
public class PrintAllWorkItems_Tests {
    ...
    public void init() {
        ...
        testCommand = new PrintAllWorkItems(trelloBoardRepository);
    ...
    public void execute_should_notThrowException_when_passedRequiredArguments() {
        trelloBoardRepository.addWorkItem(new BugImpl(1,
                "Login button bug",
    ...
    @Test
    public void printAllFeedbacks_Should_show_When_noWorkItemsExist() {
        Assertions.assertThrows(InvalidInputException.class,()-> testCommand.execute(testParameters));
    }
}
