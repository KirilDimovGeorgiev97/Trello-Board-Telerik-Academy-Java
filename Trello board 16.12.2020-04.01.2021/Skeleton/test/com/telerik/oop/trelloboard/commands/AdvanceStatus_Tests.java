...
import com.telerikacademy.oop.trelloboard.commands.changeWorkItem.AdvanceStatus;
...
public class AdvanceStatus_Tests {
    ...
    public void before() {
        ...
        testCommand = new AdvanceStatus(trelloBoardRepository);
    }
    ...
    public void execute_should_throwException_when_theStatusIsAlreadyReverted() {
        // Arrange & Act
        Bug bug = (Bug) trelloBoardFactory.createWorkItem(WorkItemTypes.BUG, 7, "TelerikAcademy", "description",
                BugStatus.FIXED, LocalDate.now(), Severity.CRITICAL, null, 0, PriorityType.HIGH);
        trelloBoardRepository.addWorkItem(bug);
